...
public class DList extends List {
  ...
  public DList() {
    ...
    size = 0;
    head = newNode(Integer.MIN_VALUE, null, null, null);//will call dyanamic method(overridden newNode) even in constructor
    head.prev = head;
    head.next = head;
  }
  ...
  public void insertFront(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
    DListNode frontNode = newNode(item, this, head, head.next);
    head.next = frontNode;
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
    DListNode backNode = newNode(item, this, head.prev, head);
    head.prev = backNode;
