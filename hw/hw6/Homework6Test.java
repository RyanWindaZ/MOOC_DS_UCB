...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    System.out.println();
    System.out.println("Key num: " + table.size());
    System.out.println("Bucket num: " + table.bucketLength());
    System.out.println("Expected Num of Collisions: " + table.expeCollisionNum());
    System.out.println("Exact Num of Collisions: " + table.exacCollisionNum());
  }
