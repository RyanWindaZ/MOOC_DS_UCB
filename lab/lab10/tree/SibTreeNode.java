...
class SibTreeNode extends TreeNode {
  ...
  public TreeNode parent() throws InvalidNodeException {
    ...
    if (!isValidNode() || this == null) throw new InvalidNodeException();
  ...
  public void insertChild(Object item, int c) throws InvalidNodeException {
    ...
    if (isValidNode()) {
      ...
      if (c <= 1 || children() == 0) {
        ...
        while (c > 2 && curNode.nextSibling != null) {
  ...
  public void removeLeaf() throws InvalidNodeException {
    ...
    if (children() == 0) {
      //System.out.println("XXXX:" + parent.item());
      if (this != myTree.root()) {
        if (this == parent.firstChild){
          parent.firstChild = this.nextSibling;
        }
        else {
          SibTreeNode curNode = parent.firstChild; 
          while (curNode.nextSibling != this) { 
            curNode = curNode.nextSibling; 
          } 
          curNode.nextSibling = this.nextSibling;
        }
      }
